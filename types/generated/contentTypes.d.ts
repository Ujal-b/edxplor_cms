...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    college: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::college-profile.college-profile'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blogPublisheddate: Attribute.String;
...
export interface ApiCollegeProfileCollegeProfile extends Schema.CollectionType {
  ...
  attributes: {
    ...
    college_description: Attribute.Blocks;
    college_type: Attribute.Enumeration<['Public', 'Private', 'Community']>;
    why_this_college: Attribute.Blocks;
    cover_img: Attribute.Media;
    logo: Attribute.Media;
    website: Attribute.String;
    affilated_uni: Attribute.Enumeration<
      [
...
export interface ApiCollegesDetailCollegesDetail extends Schema.CollectionType {
  ...
  attributes: {
    ...
    address: Attribute.String;
    totalCourses: Attribute.Integer;
    phoneNumber: Attribute.String;
    collegeType: Attribute.Enumeration<['public', 'private']>;
    graduationRate: Attribute.Integer;
    collegeEmail: Attribute.Email;
    collegeWebsite: Attribute.String;
    collegeDescription: Attribute.Text;
    collegeWhyThis: Attribute.Text;
    collegeAdmissionRequirements: Attribute.Text;
    collegeAdmissionProcedures: Attribute.Text;
    programCategories: Attribute.Relation<
      'api::colleges-detail.colleges-detail',
      'oneToMany',
      'api::program-category.program-category'
    >;
    collegeCoverImageLink: Attribute.Text;
    collegeLogoImageLink: Attribute.String;
...
export interface ApiProgramProgram extends Schema.CollectionType {
  ...
  attributes: {
    ...
    programDescription: Attribute.Text;
    category: Attribute.Relation<
      'api::program.program',
      'manyToOne',
      'api::program-category.program-category'
    >;
    whyThisCourse: Attribute.Text;
    available_colleges: Attribute.Relation<
      'api::program.program',
      'oneToMany',
      'api::colleges-detail.colleges-detail'
    >;
    averageFee: Attribute.String;
    courseDuration: Attribute.String;
    programCoverLink: Attribute.String;
    faqs: Attribute.Relation<
      'api::program.program',
      'oneToMany',
      'api::faq.faq'
    >;
    degree: Attribute.Enumeration<['Master', 'PhD', 'Bachelor']>;
    fieldOfStudy: Attribute.Enumeration<
      ['IT', 'Medical', 'Law', 'Teacher education']
    >;
    eligibilityCriteria: Attribute.String;
    admissionProcess: Attribute.String;
    examType: Attribute.String;
    careerOptions: Attribute.String;
    courseShortName: Attribute.String;
    requirementList: Attribute.Blocks;
...
export interface ApiProgramCategoryProgramCategory
  ...
  attributes: {
    programCategory: Attribute.String;
    programName: Attribute.Relation<
      'api::program-category.program-category',
      'oneToMany',
      'api::program.program'
    >;
    collegeName: Attribute.Relation<
      'api::program-category.program-category',
      'manyToOne',
      'api::colleges-detail.colleges-detail'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::college-profile.college-profile': ApiCollegeProfileCollegeProfile;
      'api::colleges-detail.colleges-detail': ApiCollegesDetailCollegesDetail;
